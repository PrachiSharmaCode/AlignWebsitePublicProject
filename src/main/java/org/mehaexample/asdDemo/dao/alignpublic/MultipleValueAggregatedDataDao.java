...
public class MultipleValueAggregatedDataDao {
  ...
  /**
   * Get the session factory connection to the database.
   */
  ...
  /**
   * Get the session factory connection to the database.
   * This is only for connecting to the test database in local.
   *
   * @param test boolean variable.
   */
  ...
  /**
   * Get the list of undergrad majors that current students had
   * and their counts.
   *
   * @return list of undergrad majors of current students had
   * and their counts.
   */
